...
const KnowledgeSource_1 = __importDefault(require("../src/models/KnowledgeSource"));
...
describe("Knowledge Admin Routes", () => {
    ...
    describe("Authorization", () => {
        it("rejects unauthenticated requests", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            auth.authenticateJWT.mockImplementationOnce((req, res) => res.status(401).json({ message: "Unauthorized" }));
            const res = yield (0, supertest_1.default)(app).get("/api/knowledge");
            expect(res.status).toBe(401);
        }));
        it("rejects non-admin requests", () => __awaiter(void 0, void 0, void 0, function* () {
            const auth = require("../src/middleware/auth");
            auth.requireAdmin.mockImplementationOnce((req, res) => res.status(403).json({ message: "Unauthorized: Admin access required" }));
            const res = yield (0, supertest_1.default)(app).get("/api/knowledge");
            expect(res.status).toBe(403);
        }));
    });
    describe("GET /api/knowledge", () => {
        it("returns paginated sources", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const res = yield (0, supertest_1.default)(app).get("/api/knowledge?page=1&limit=10");
    ...
    describe("POST /api/knowledge", () => {
        it("validates required fields", () => __awaiter(void 0, void 0, void 0, function* () {
            const res = yield (0, supertest_1.default)(app).post("/api/knowledge").send({});
            expect(res.status).toBe(400);
            expect(res.body.errors).toBeDefined();
        }));
        it("creates a new source and ingests it", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            knowledgeBase_1.ingestKnowledgeSource.mockResolvedValue({ chunkCount: 5 });
            const res = yield (0, supertest_1.default)(app).post("/api/knowledge").send({
                title: "Test",
                content: "Content",
                sourceType: "bio"
            ...
            expect(knowledgeBase_1.ingestKnowledgeSource).toHaveBeenCalledWith(expect.objectContaining({
                title: "Test",
                sourceType: "bio"
            }));
        }));
    ...
    describe("POST /api/knowledge/sync", () => {
        it("syncs manifest items", () => __awaiter(void 0, void 0, void 0, function* () {
            const mockSources = [{
                    externalId: "ext-1",
                    title: "Test",
                    content: "Content",
            ...
            KnowledgeSource_1.default.findOne.mockResolvedValue(null);
            knowledgeBase_1.ingestKnowledgeSource.mockResolvedValue({ chunkCount: 2 });
            const mockSave = jest.fn().mockResolvedValue(true);
            KnowledgeSource_1.default.mockImplementation(() => ({
                _id: "ext-1-id",
                title: "Test",
            ...
            const res = yield (0, supertest_1.default)(app).post("/api/knowledge/sync").send({ sources: mockSources });
            expect(res.status).toBe(200);
