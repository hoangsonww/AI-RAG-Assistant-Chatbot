 ...
 *         description: Internal server error.
 */
router.get("/:id/summary", auth_1.authenticateJWT, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userId = req.user.id;
        const conversation = yield Conversation_1.default.findOne({
            _id: req.params.id,
 ...
 *         description: Internal server error.
 */
router.post("/:id/summary", auth_1.authenticateJWT, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userId = req.user.id;
        const conversation = yield Conversation_1.default.findOne({
            _id: req.params.id,
        ...
        const summaryData = yield (0, geminiService_1.generateConversationSummary)(conversation.messages);
