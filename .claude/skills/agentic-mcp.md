---
name: agentic-mcp
description: Use when changing the Python multi-agent pipeline or MCP server under agentic_ai/, including orchestration, agent flow, configuration loading, MCP tools, prompts, resources, or the Python deployment wrappers for that subsystem.
---
...
1. Keep pipeline behavior flowing through `core/`, `agents/`, and `mcp_server/` rather than adding one-off bypass logic.
